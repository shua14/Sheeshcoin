...
class Transaction:
    '''
    Document of an exchange from a sender to one or more recipients.
    '''
    ...
    def create_input(self, sender_wallet, output):
        ...
        Also sign the transaction and include sender's public key and adress
        '''
    ...
    def from_json(transaction_json):
        '''
        Deserialize a transaction's json representation into a Transaction instance
        '''
        return Transaction(
