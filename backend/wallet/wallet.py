...
class Wallet:
    ...
    def sign(self, data):
        '''
        Genearte a signature based on the data using the local private key
        '''
    ...
    def calculate_balance(blockchain, address):
        ...
        The balance is found by adding the output values that belong to the address since the most recent transaction by that 
        address
        '''
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    # Anytime the address cpnducts a new transaction it restes its address
...
def main():
    wallet = Wallet()
    print(f'wallet.--dict__: {wallet.__dict__}')
